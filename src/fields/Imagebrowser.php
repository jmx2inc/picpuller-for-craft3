...
namespace jmx2\picpuller\fields;

use jmx2\picpuller\PicPuller;
use jmx2\picpuller\assetbundles\field\FieldAsset;
 ...
 * @since     3.0.0
 */
class Imagebrowser extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('pic-puller', 'Pic Puller: Instagram Browser');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'pic-puller/_components/fields/_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        $namespacedId = Craft::$app->getView()->namespaceInputId($id);
        $adminPath = Craft::$app->config->general->cpTrigger;
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PicPuller(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'pic-puller/_components/fields/_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
